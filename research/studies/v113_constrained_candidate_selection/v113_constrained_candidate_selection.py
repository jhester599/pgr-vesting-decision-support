...
def main() -> None:
    baseline = pd.read_csv(study_output_path("v95_policy_replay_results.csv"))
    ...
    candidate_frames = [
        _load_results(
            study_output_path("v110_gemini_veto_gate_results.csv"),
            "v110",
            "veto_regression_sell",
        ),
        _load_results(
            study_output_path("v111_permission_overlay_results.csv"),
            "v111",
            "permission_to_deviate",
        ),
        _load_results(
            study_output_path("v112_target_reformulation_results.csv"),
            "v112",
