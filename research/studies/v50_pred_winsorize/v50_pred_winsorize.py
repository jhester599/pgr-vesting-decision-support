...
def load_v38_alpha() -> float:
    ...
    best_path = Path("research/studies/v38_shrinkage/outputs/v38_shrinkage_best_results.csv")
    if best_path.exists():
    ...
    grid_path = Path("research/studies/v38_shrinkage/outputs/v38_shrinkage_results.csv")
    if grid_path.exists():
