...
OUTPUT_DIR = Path("research") / "studies" / "x8_synthesis" / "outputs"
SUMMARY_PATH = OUTPUT_DIR / "x8_synthesis_summary.json"
MEMO_PATH = OUTPUT_DIR / "x8_synthesis_memo.md"

INPUT_SUMMARIES = {
    "x2": study_output_path("x2_absolute_classification_summary.json"),
    "x3": study_output_path("x3_direct_return_summary.json"),
    "x4": study_output_path("x4_bvps_forecasting_summary.json"),
    "x5": study_output_path("x5_decomposition_summary.json"),
    "x6": study_output_path("x6_special_dividend_summary.json"),
    "x7": study_output_path("x7_targeted_ta_summary.json"),
}
