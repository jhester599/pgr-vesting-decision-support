...
def _best_v92_candidate_name() -> str:
    path = Path("research/studies/v92_calibration_and_abstention/outputs/v92_calibration_and_abstention_results.csv")
    if not path.exists():
...
def _best_v93_basket_candidate_name() -> str:
    path = Path("research/studies/v93_basket_targets/outputs/v93_basket_targets_results.csv")
    if not path.exists():
...
def main() -> None:
    ...
    detail_df.to_csv("research/studies/v94_hybrid_gate/outputs/v94_hybrid_gate_detail.csv", index=False)
    write_markdown_summary(
        Path("research/studies/v94_hybrid_gate/outputs/v94_hybrid_gate_summary.md"),
