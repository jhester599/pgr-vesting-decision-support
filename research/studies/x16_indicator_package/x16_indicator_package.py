...
OUTPUT_DIR = Path("research") / "studies" / "x16_indicator_package" / "outputs"
...
def main() -> None:
    x14 = _load_json(study_output_path("x14_indicator_synthesis_summary.json"))
    x15 = _load_json(study_output_path("x15_pb_regime_overlay_summary.json"))
