...
def main() -> None:
    scorecard = pd.read_csv(Path("research/studies/v119_disagreement_scorecard/outputs/v119_disagreement_scorecard_results.csv"))
    assessment = pd.read_csv(
        Path("research/studies/v120_prospective_shadow_gate_assessment/outputs/v120_prospective_shadow_gate_assessment_results.csv")
    )
