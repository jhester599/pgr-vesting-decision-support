...
FEATURE_INVENTORY_PATH = study_output_path("v128_feature_inventory.csv")
BASELINE_PATH = study_output_path("v128_baseline_metrics.csv")
SINGLE_FEATURE_PATH = study_output_path("v128_single_feature_results.csv")
FORWARD_TRACE_PATH = study_output_path("v128_forward_stepwise_trace.csv")
# Over 1 MB: written to the gitignored outputs/detail/ (review 2026-09-25, phase 3).
REGULARIZED_SELECTION_PATH = study_output_path(
    "v128_regularized_selection_detail.csv", detail=True
)
REGULARIZED_COMPARISON_PATH = study_output_path("v128_regularized_comparison.csv")
COMPARISON_PATH = study_output_path("v128_benchmark_feature_search_comparison.csv")
FEATURE_MAP_PATH = study_output_path("v128_benchmark_feature_map.csv")
SUMMARY_PATH = study_output_path("v128_benchmark_feature_search_summary.md")
...
def _write_outputs(
    ...
    *,
    ...
    save_results(
        artifacts["regularized_selection"], REGULARIZED_SELECTION_PATH.name, detail=True
    )
    ...
    body_lines.extend(
        [
            ...
            "- `detail/v128_regularized_selection_detail.csv` (not committed): fold-level L1 / "
            "elastic-net feature selections",
