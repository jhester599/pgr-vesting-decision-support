...
Outputs
-------
  research/studies/v132_threshold_validation/outputs/v132_threshold_validation_results.csv
  research/studies/v132_threshold_validation/outputs/v132_threshold_validation_summary.md
"""
...
FOLD_DETAIL_PATH: Path = (
    PROJECT_ROOT / "research" / "studies" / "v125_portfolio_target_classifier" / "outputs" / "v125_portfolio_target_fold_detail.csv"
)
RESULTS_PATH: Path = (
    PROJECT_ROOT / "research" / "studies" / "v132_threshold_validation" / "outputs" / "v132_threshold_validation_results.csv"
)
SUMMARY_PATH: Path = (
    PROJECT_ROOT / "research" / "studies" / "v132_threshold_validation" / "outputs" / "v132_threshold_validation_summary.md"
)
