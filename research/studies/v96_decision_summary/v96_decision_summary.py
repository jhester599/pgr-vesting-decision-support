...
def main() -> None:
    ...
    v87 = _selected_row("research/studies/v87_target_taxonomy/outputs/v87_target_taxonomy_results.csv", "recommended_next")
    v88 = _selected_row("research/studies/v88_feature_sweep/outputs/v88_feature_sweep_results.csv", "selected_next")
    v89 = _selected_row("research/studies/v89_per_benchmark_linear/outputs/v89_per_benchmark_linear_results.csv", "selected_next")
    v90 = _selected_row("research/studies/v90_pooled_panel_classifiers/outputs/v90_pooled_panel_classifiers_results.csv", "selected_next")
    v91 = _selected_row("research/studies/v91_nonlinear_classifier_sweep/outputs/v91_nonlinear_classifier_sweep_results.csv", "selected_next")
    v92 = _selected_row("research/studies/v92_calibration_and_abstention/outputs/v92_calibration_and_abstention_results.csv", "selected_next")
    v93 = _selected_row("research/studies/v93_basket_targets/outputs/v93_basket_targets_results.csv", "selected_next")
    v94 = _selected_row("research/studies/v94_hybrid_gate/outputs/v94_hybrid_gate_results.csv", "selected_next")
    v95 = _selected_row("research/studies/v95_policy_replay/outputs/v95_policy_replay_results.csv", "selected_next")
    ...
    if v94 is not None and v95 is not None:
        regression_df = pd.read_csv("research/studies/v94_hybrid_gate/outputs/v94_hybrid_gate_results.csv")
        regression_row = regression_df.loc[
            regression_df["variant"] == "regression_only_quality_weighted"
        ].iloc[0]
        best_replay = pd.read_csv("research/studies/v95_policy_replay/outputs/v95_policy_replay_results.csv")
    ...
    write_markdown_summary(
        Path("research/studies/v96_decision_summary/outputs/v96_decision_summary.md"),
