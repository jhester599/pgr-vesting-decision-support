...
Usage
-----
python research/studies/v129_feature_map_eval/v129_feature_map_eval.py --strategy lean_baseline
python research/studies/v129_feature_map_eval/v129_feature_map_eval.py --strategy v128_map
python research/studies/v129_feature_map_eval/v129_feature_map_eval.py --strategy file:research/studies/v129_feature_map_eval/outputs/v129_candidate_map.csv
...
from research.studies.v128_benchmark_feature_search.v128_benchmark_feature_search import (
    CachedEvaluator,
    benchmark_universe,
...
RESULTS_DIR = PROJECT_ROOT / "research" / "studies" / "v129_feature_map_eval" / "outputs"
V128_COMPARISON_PATH = study_output_path("v128_benchmark_feature_search_comparison.csv")
V128_MAP_PATH = PROJECT_ROOT / V128_BENCHMARK_FEATURE_MAP_PATH
V129_CANDIDATE_MAP_PATH = study_output_path("v129_candidate_map.csv")
