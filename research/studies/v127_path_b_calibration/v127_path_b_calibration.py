...
RESULTS_DIR = PROJECT_ROOT / "research" / "studies" / "v127_path_b_calibration" / "outputs"
FOLD_DETAIL_PATH = study_output_path("v125_portfolio_target_fold_detail.csv")
RESULTS_PATH = study_output_path("v127_path_b_calibration_results.csv")
DETAIL_PATH = study_output_path("v127_path_b_calibration_detail.csv")
SUMMARY_PATH = study_output_path("v127_path_b_calibration_summary.md")
ABSTAIN_WIDTH = 0.20
MIN_HISTORY = 24
