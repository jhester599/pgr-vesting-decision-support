...
Usage:
    python research/studies/v125_portfolio_target_classifier/v125_portfolio_target_classifier.py
    python research/studies/v125_portfolio_target_classifier/v125_portfolio_target_classifier.py --as-of 2024-03-31

Outputs (written to research/studies/v125_portfolio_target_classifier/outputs/):
...
OUTPUT_DIR = PROJECT_ROOT / "research" / "studies" / "v125_portfolio_target_classifier" / "outputs"
