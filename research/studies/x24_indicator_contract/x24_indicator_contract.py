...
RESULTS_DIR = study_output_path("x24_indicator_contract.json").parent
DOCS_DIR = Path("docs") / "research"
CONTRACT_PATH = study_output_path("x24_indicator_contract.json")
MEMO_PATH = study_output_path("x24_research_memo.md")
BUNDLE_PROMPT_PATH = study_output_path("x24_bundle_peer_review_prompt.md")
STRUCTURAL_PROMPT_PATH = study_output_path("x24_structural_peer_review_prompt.md")
...
def write_resume_doc(
    *,
    ...
    lines = [
        ...
        "",
        f"- Dividend lane prompt: [x23 peer review](../../x23_dividend_lane_package/outputs/x23_peer_review_prompt.md)",
        f"- Holistic bundle prompt: [x24 bundle peer review](x24_bundle_peer_review_prompt.md)",
        f"- Structural P/B prompt: [x24 structural peer review](x24_structural_peer_review_prompt.md)",
        f"- Earlier structural prompt: [x16 peer review](../../x16_indicator_package/outputs/x16_peer_review_prompt.md)",
        "",
        "## Resume Advice",
        "",
...
def main() -> None:
    x8_summary = _read_json(study_output_path("x8_synthesis_summary.json"))
    x11_summary = _read_json(study_output_path("x11_capital_synthesis_summary.json"))
    x16_package = _read_json(study_output_path("x16_indicator_package.json"))
    x23_package = _read_json(study_output_path("x23_dividend_lane_package.json"))
