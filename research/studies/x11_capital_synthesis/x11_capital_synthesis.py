...
OUTPUT_DIR = Path("research") / "studies" / "x11_capital_synthesis" / "outputs"
...
INPUT_SUMMARIES = {
    ...
    "x8": study_output_path("x8_synthesis_summary.json"),
    "x9": study_output_path("x9_bvps_bridge_summary.json"),
    "x10": study_output_path("x10_dividend_capital_summary.json"),
}
