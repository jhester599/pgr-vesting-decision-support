...
def main() -> None:
    ...
    detail_path = study_output_path("v75_holdout_shadow_replay_detail.csv")
    summary_path = study_output_path("v75_holdout_shadow_replay_summary.csv")
    memo_path = study_output_path("v75_holdout_shadow_replay_decision.md")
