...
RESULTS_DIR = PROJECT_ROOT / "research" / "studies" / "v130_path_b_temp_scaling_adoption" / "outputs"
FOLD_DETAIL_PATH = study_output_path("v125_portfolio_target_fold_detail.csv")
RESULTS_PATH = study_output_path("v130_path_b_temp_scaling_results.csv")
SUMMARY_PATH = study_output_path("v130_path_b_temp_scaling_summary.md")
