...
from research.studies.v146_threshold_sweep.v146_threshold_sweep import DEFAULT_TEMP_MAX_PATH, DEFAULT_WARMUP_PATH

DEFAULT_CANDIDATE_PATH = PROJECT_ROOT / "research" / "studies" / "v147_coverage_weighted_aggregate" / "outputs" / "v147_path_b_multiplier_candidate.txt"
