...
def main() -> None:
    ranked = pd.read_csv(study_output_path("v113_constrained_candidate_selection_results.csv"))
    monitoring = pd.read_csv(study_output_path("v115_classifier_monitoring_summary_results.csv"))
