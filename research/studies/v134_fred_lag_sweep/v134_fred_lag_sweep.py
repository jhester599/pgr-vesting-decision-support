...
Usage:
    ...
    python research/studies/v134_fred_lag_sweep/v134_fred_lag_sweep.py --lag-overrides "{\"GS10\": 0}"
    python research/studies/v134_fred_lag_sweep/v134_fred_lag_sweep.py --params-file research/studies/v134_fred_lag_sweep/outputs/v134_lag_candidate.json
...
DEFAULT_CANDIDATE_PATH = (
    PROJECT_ROOT / "research" / "studies" / "v134_fred_lag_sweep" / "outputs" / "v134_lag_candidate.json"
)
