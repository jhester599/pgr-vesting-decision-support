...
from research.studies.v149_kelly_eval.v149_kelly_eval import DEFAULT_CANDIDATE_PATH as DEFAULT_KELLY_CANDIDATE_PATH, evaluate_kelly_params

DEFAULT_CANDIDATE_PATH = PROJECT_ROOT / "research" / "studies" / "v150_neutral_band_eval" / "outputs" / "v150_neutral_band_candidate.txt"
