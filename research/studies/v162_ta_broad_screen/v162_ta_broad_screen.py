...
OUTPUT_DIR = Path("research") / "studies" / "v162_ta_broad_screen" / "outputs"
# Over 1 MB: written to the gitignored outputs/detail/ (review 2026-09-25, phase 3).
DETAIL_PATH = OUTPUT_DIR / "detail" / "v162_ta_broad_screen_detail.csv"
...
def write_screen_artifacts(
    ...
    detail_path = output_dir / "detail" / DETAIL_PATH.name
