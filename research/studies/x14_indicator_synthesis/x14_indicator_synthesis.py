...
OUTPUT_DIR = Path("research") / "studies" / "x14_indicator_synthesis" / "outputs"
...
def main() -> None:
    x3 = _load_json(study_output_path("x3_direct_return_summary.json"))
    x5 = _load_json(study_output_path("x5_decomposition_summary.json"))
    x8 = _load_json(study_output_path("x8_synthesis_summary.json"))
    x11 = _load_json(study_output_path("x11_capital_synthesis_summary.json"))
    x12 = _load_json(study_output_path("x12_bvps_target_audit_summary.json"))
    x13 = _load_json(study_output_path("x13_adjusted_decomposition_summary.json"))
