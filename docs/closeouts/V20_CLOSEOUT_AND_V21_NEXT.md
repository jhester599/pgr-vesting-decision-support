...
- Decision rationale: The best assembled v20 stack improved reduced-universe metrics, but it still diverged too much from the promoted simpler baseline to replace the current live cross-check.
