...
def test_build_augmented_features_adds_wti() -> None:
    from research.studies.v155_wti_momentum_eval.v155_wti_momentum_eval import build_augmented_feature_cols
...
def test_run_wti_evaluation_writes_candidate(tmp_path: Path) -> None:
    from research.studies.v155_wti_momentum_eval.v155_wti_momentum_eval import run_wti_evaluation
...
def test_candidate_file_schema() -> None:
    import json
    from research.studies.v155_wti_momentum_eval.v155_wti_momentum_eval import DEFAULT_CANDIDATE_PATH
