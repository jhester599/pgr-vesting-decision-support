...
from research.studies.v146_threshold_sweep.v146_threshold_sweep import DEFAULT_CANDIDATE_PATH, evaluate_threshold_candidate, main
...
def test_main_returns_exit_code_1_when_coverage_too_low(tmp_path: Path) -> None:
    ...
    with patch("research.studies.v146_threshold_sweep.v146_threshold_sweep.FOLD_DETAIL_PATH", csv_path):
