...
def test_compute_term_premium_diff_basic() -> None:
    from research.studies.v157_term_premium_eval.v157_term_premium_eval import compute_term_premium_diff
...
def test_augment_feature_df_adds_column() -> None:
    from research.studies.v157_term_premium_eval.v157_term_premium_eval import augment_with_term_diff
...
def test_run_term_premium_evaluation_writes_candidate(tmp_path: Path) -> None:
    from research.studies.v157_term_premium_eval.v157_term_premium_eval import run_term_premium_evaluation
...
def test_candidate_file_schema() -> None:
    import json
    from research.studies.v157_term_premium_eval.v157_term_premium_eval import DEFAULT_CANDIDATE_PATH
