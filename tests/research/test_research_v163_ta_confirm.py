...
def test_survivor_cap_is_enforced_for_features_and_groups() -> None:
    from research.studies.v163_ta_survivor_confirm.v163_ta_survivor_confirm import select_survivors
...
def test_correlation_pruning_removes_redundant_ta_features() -> None:
    from research.studies.v163_ta_survivor_confirm.v163_ta_survivor_confirm import prune_correlated_features
...
def test_regime_slices_are_stably_labeled() -> None:
    from research.studies.v163_ta_survivor_confirm.v163_ta_survivor_confirm import assign_regime_slice
...
def test_candidate_json_is_deterministic() -> None:
    from research.studies.v163_ta_survivor_confirm.v163_ta_survivor_confirm import build_candidate_payload
