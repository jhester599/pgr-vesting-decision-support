...
def test_candidate_inventory_contains_expected_alpha_vantage_families() -> None:
    from research.studies.v162_ta_broad_screen.v162_ta_broad_screen import build_candidate_inventory
...
def test_add_and_replacement_modes_generate_distinct_feature_sets() -> None:
    from research.studies.v162_ta_broad_screen.v162_ta_broad_screen import build_feature_set_specs
...
def test_regression_and_classification_records_contain_baseline_deltas() -> None:
    from research.studies.v162_ta_broad_screen.v162_ta_broad_screen import attach_baseline_deltas
...
def test_classification_positive_count_uses_ba_and_brier() -> None:
    from research.studies.v162_ta_broad_screen.v162_ta_broad_screen import summarize_screen
...
def test_compact_detail_records_removes_stale_expansion() -> None:
    from research.studies.v162_ta_broad_screen.v162_ta_broad_screen import compact_detail_records
...
def test_broad_screen_script_can_run_from_file_path() -> None:
    result = subprocess.run(
        [
            sys.executable,
            "research/studies/v162_ta_broad_screen/v162_ta_broad_screen.py",
            "--help",
        ],
        cwd=PROJECT_ROOT,
        text=True,
