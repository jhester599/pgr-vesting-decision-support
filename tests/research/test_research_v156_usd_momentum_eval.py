...
def test_usd_target_benchmarks_constant() -> None:
    from research.studies.v156_usd_momentum_eval.v156_usd_momentum_eval import TARGET_BENCHMARKS
    for bm in ["BND", "VXUS", "VWO"]:
        assert bm in TARGET_BENCHMARKS


def test_build_usd_augmented_cols_no_duplicates() -> None:
    from research.studies.v156_usd_momentum_eval.v156_usd_momentum_eval import build_augmented_feature_cols
...
def test_run_usd_evaluation_writes_candidate(tmp_path: Path) -> None:
    from research.studies.v156_usd_momentum_eval.v156_usd_momentum_eval import run_usd_evaluation
...
def test_candidate_file_schema() -> None:
    import json
    from research.studies.v156_usd_momentum_eval.v156_usd_momentum_eval import DEFAULT_CANDIDATE_PATH
