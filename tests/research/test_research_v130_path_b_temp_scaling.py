...
def _import_evaluate():
    ...
    script_path = (
        PROJECT_ROOT / "research" / "studies" / "v130_path_b_temp_scaling_adoption" / "v130_path_b_temp_scaling_adoption.py"
    )
...
def test_output_csv_has_required_columns() -> None:
    ...
    p = PROJECT_ROOT / "research" / "studies" / "v130_path_b_temp_scaling_adoption" / "outputs" / "v130_path_b_temp_scaling_results.csv"
    if not p.exists():
...
def test_summary_md_exists() -> None:
    ...
    p = PROJECT_ROOT / "research" / "studies" / "v130_path_b_temp_scaling_adoption" / "outputs" / "v130_path_b_temp_scaling_summary.md"
    if not p.exists():
