...
def test_apply_feature_swaps_preserves_order_and_feature_count() -> None:
    from research.studies.v165_ta_shadow_replacement_eval.v165_ta_shadow_replacement_eval import apply_feature_swaps
...
def test_candidate_variants_are_replacement_only() -> None:
    from research.studies.v165_ta_shadow_replacement_eval.v165_ta_shadow_replacement_eval import (
...
def test_attach_variant_deltas_uses_balanced_accuracy_and_brier() -> None:
    from research.studies.v165_ta_shadow_replacement_eval.v165_ta_shadow_replacement_eval import attach_variant_deltas
...
def test_summarize_variants_counts_positive_benchmarks() -> None:
    from research.studies.v165_ta_shadow_replacement_eval.v165_ta_shadow_replacement_eval import summarize_variants
