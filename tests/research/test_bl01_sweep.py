...
def test_make_scenario_returns_correct_shapes() -> None:
    from research.studies.bl01_tau_sweep_eval.bl01_tau_sweep_eval import BENCHMARKS, _make_scenario
...
def test_rank_corr_perfect_positive() -> None:
    from research.studies.bl01_tau_sweep_eval.bl01_tau_sweep_eval import _rank_corr
...
def test_compute_ic_rank_correlation_positive_alignment() -> None:
    ...
    from research.studies.bl01_tau_sweep_eval.bl01_tau_sweep_eval import (
...
def test_select_winner_keeps_incumbent_when_delta_below_threshold() -> None:
    from research.studies.bl01_tau_sweep_eval.bl01_tau_sweep_eval import select_winner
    rows = [
