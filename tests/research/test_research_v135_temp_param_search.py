...
from research.studies.v135_temp_param_search.v135_temp_param_search import (
    DEFAULT_HIGH_THRESH,
    DEFAULT_LOW_THRESH,
    DEFAULT_N_TEMPS,
    DEFAULT_TEMP_MAX,
...
def test_main_returns_exit_code_1_when_coverage_too_low(tmp_path: Path) -> None:
    ...
    with patch(
        "research.studies.v135_temp_param_search.v135_temp_param_search.FOLD_DETAIL_PATH",
        csv_path,
    ):
        rc = main(
            [
