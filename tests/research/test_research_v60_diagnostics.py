...
def test_csv_exists() -> None:
    assert Path("research/studies/v60_diagnostics/outputs/v60_diagnostics_results.csv").exists()


@pytest.mark.artifact
def test_pooled_row_present() -> None:
    df = pd.read_csv(Path("research/studies/v60_diagnostics/outputs/v60_diagnostics_results.csv"))
