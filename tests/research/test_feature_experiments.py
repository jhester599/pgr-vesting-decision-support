...
from research.studies.v9_experiments.feature_experiments import _experiment_specs, run_feature_experiments, summarize_feature_experiments
...
def test_run_feature_experiments_produces_rows(tmp_path):
    ...
    with (
        patch("research.studies.v9_experiments.feature_experiments.build_feature_matrix_from_db", return_value=fake_df),
        patch("research.studies.v9_experiments.feature_experiments.load_relative_return_matrix", return_value=fake_series),
        patch("research.studies.v9_experiments.feature_experiments.get_X_y_relative", return_value=(fake_df.drop(columns=["target_6m_return"]), fake_series)),
