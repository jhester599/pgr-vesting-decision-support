...
SWEEP = Path("research/studies/v38_shrinkage/outputs/v38_shrinkage_results.csv")
BEST = Path("research/studies/v38_shrinkage/outputs/v38_shrinkage_best_results.csv")
