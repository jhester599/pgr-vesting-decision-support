...
CSV_PATH = Path("research/studies/v94_hybrid_gate/outputs/v94_hybrid_gate_results.csv")
DETAIL_PATH = Path("research/studies/v94_hybrid_gate/outputs/v94_hybrid_gate_detail.csv")
