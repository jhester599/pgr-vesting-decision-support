...
from research.studies.v9_experiments.pooled_benchmark_experiments import (
...
def test_build_pooled_relative_targets_averages_available_members():
    ...
    with patch("research.studies.v9_experiments.pooled_benchmark_experiments.load_relative_return_matrix", side_effect=_fake_loader):
