...
from research.studies.v129_feature_map_eval.v129_feature_map_eval import (
    MIN_COVERAGE,
...
def test_main_returns_exit_code_1_when_coverage_too_low(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "research.studies.v129_feature_map_eval.v129_feature_map_eval.evaluate_feature_map",
