...
- What changed since last month: Previous logged month (2026-04-11) was NEUTRAL at -2.06% with mean IC 0.1554.
- Current model view: Consensus signal is NEUTRAL, but the average relative-return forecast is -2.16% across benchmarks over the next 6 months. Recommendation mode remains DEFER-TO-TAX-DEFAULT.
- How trustworthy it is: Model quality is too weak to justify a prediction-led vesting action. Aggregate health: OOS R^2 -5.02%, IC 0.1645, hit rate 66.8%.
...
|------|-------------|-----|-------|--------|
| Daily prices | 2026-04-17 | 3 days | 10 days | **OK** |
| FRED macro | 2026-04-30 | 0 days | 45 days | **OK** |
| PGR monthly EDGAR | 2026-02-28 | 51 days | 25-day filing grace | **OK** |
...
- Shadow classifier probability: **35.9%** (MODERATE)
- **Portfolio-aligned P(Actionable Sell):** 42.3% [NEUTRAL] _(investable pool, fixed weights)_
...
| Recommended Sell % | **50%** |
| Predicted 6M Relative Return | -2.16% |
| P(Outperform, raw) | 50.0% |
| P(Outperform, calibrated) | 64.1% |
| 80% Prediction Interval (median) | -35.40% to +26.29% |
| Mean IC (across benchmarks) | 0.1509 |
| Mean Hit Rate | 65.9% |
| Aggregate OOS R^2 | -5.02% |
...
>
> **Calibration:** Phase 2 — Platt scaling active (n=1,188 OOS obs).  ECE = 2.3% [95% CI: 1.7%–7.1%].
...
| Portfolio-aligned P(Actionable Sell) | 42.3% [NEUTRAL] |
...
| Interpretation | Shadow classifier is near its neutral band (35.9%); use it as a low-confidence interpretation layer rather than a decision override. |
...
|-------|---------|-----------|--------|---------|
| Mean IC | 0.1509 | >= 0.0700 | **PASS** | Cross-benchmark ranking signal. |
| Mean hit rate | 65.9% | >= 55.0% | **PASS** | Directional accuracy versus zero. |
| Aggregate OOS R^2 | -5.02% | >= 2.00% | **FAIL** | Calibration / fit versus a naive benchmark. |
...
|--------|---|-------------|---------------|--------------------|--------------------|---------------|---------|
| Model: sign (hold if pred > 0) | 1188 | +7.67% | +9112.81% | +7.67% | -0.40% | +3.64% | 63.5% |
| Model: tiered 25/50/100 | 1188 | +1.99% | +2362.22% | +1.99% | -6.08% | -2.05% | 16.5% |
| Model: neutral band ±2% | 1188 | +7.40% | +8793.24% | +7.40% | -0.67% | +3.37% | 61.3% |
| Model: neutral band ±3% | 1188 | +6.87% | +8163.39% | +6.87% | -1.20% | +2.84% | 56.9% |
...
|------|------------|--------|--------------------|-----------------|-----------------|------------------------|
| VOO | 28% | Broad US equity core | Core US beta sleeve that keeps the portfolio equity-heavy without recreating single-stock PGR risk. | 0.14 | Keep near base (+0.7%) | 32.0% |
...
| VWO | 16% | Emerging-markets satellite | Higher-growth international sleeve kept modest because it is more volatile than the core international allocation. | 0.30 | Supportive (-0.1%) | n/a |
| VXUS | 11% | International core | Primary geographic diversifier away from a US employer-stock concentration. | 0.28 | Keep near base (+2.1%) | 29.9% |
| BND | 6% | Bond ballast | Small stabilizer sleeve kept intentionally light so the redeploy portfolio stays above 90% equities in normal months. | 0.04 | Only keep at floor weight (+3.6%) | 24.5% |
...
|-----------|----------------|-------------|----------------|----------|----------|----|----------|--------|--------|------------|--------|
| VOO | Buy candidate | S&P 500 | +0.67% | -27.13% | +28.47% | -0.0022 | 52.3% | 50.0% | 68.0% | LOW | NEUTRAL |
| VXUS | Buy candidate | Total International Stock | +2.13% | -34.80% | +39.05% | 0.0721 | 68.5% | 50.0% | 70.1% | LOW | OUTPERFORM |
| VWO | Buy candidate | Emerging Markets | -0.08% | -36.01% | +35.84% | 0.1361 | 60.3% | 50.0% | 74.5% | LOW | NEUTRAL |
| VMBS | Forecast only | Mortgage-Backed Securities | +3.29% | -18.15% | +24.73% | 0.2426 | 77.5% | 50.0% | 72.3% | LOW | OUTPERFORM |
| BND | Buy candidate | Total Bond Market | +3.64% | -17.81% | +25.08% | 0.2643 | 69.0% | 50.0% | 75.5% | LOW | OUTPERFORM |
| GLD | Forecast only | Gold Shares | -7.67% | -42.84% | +27.50% | 0.1395 | 57.8% | 50.0% | 60.0% | LOW | UNDERPERFORM |
| DBC | Forecast only | DB Commodity Index | -9.05% | -37.26% | +19.17% | 0.1682 | 72.6% | 50.0% | 44.6% | LOW | UNDERPERFORM |
| VDE | Forecast only | Energy | -11.15% | -42.12% | +19.82% | 0.0980 | 62.2% | 50.0% | 47.9% | LOW | UNDERPERFORM |
...
| Current model prediction (6M) | -2.16% |
| P(outperform) | 64.1% |
| Next time-based vest | 2027-01-19 |
| Next performance vest | 2026-07-17 |

⚠️ **Model predicts negative return (-2.2%).**  Consider capital-loss harvesting scenario — a tax loss at 37% STCG rate can offset other gains.  See three-scenario analysis at vesting.
